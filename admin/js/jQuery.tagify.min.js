...
!function (a) {
    ...
    a.fn.tagify = function () {
        ...
        isIE: window.document.documentMode, TEXTS: {empty: "empty", exceed: "number of tags exceeded", pattern: "pattern mismatch", duplicate: "already exists", notAllowed: "not allowed"}, DEFAULTS: {delimiters: ",", pattern: null, maxTags: 1 / 0, callbacks: {}, addTagOnBlur: !0, duplicates: !1, whitelist: [], blacklist: [], enforceWhitelist: !1, keepInvalidTags: !1, autoComplete: !0, mixTagsAllowedAfter: /,|\.|\:|\s/, backspace: !0, skipInvalid: !1, dropdown: {classname: "", enabled: 2, maxItems: 10, itemTemplate: "", fuzzySearch: !0}}, templates: {
            wrapper: function (t, e) {
                return '<tags class="tagify ' + (e.mode ? "tagify--mix" : "") + " " + t.className + '"\n                          ' + (e.readonly ? 'readonly aria-readonly="true"' : 'aria-haspopup="true" aria-expanded="false"') + '\n                          role="tagslist">\n                <span contenteditable data-placeholder="' + (t.placeholder || "&#8203;") + '" aria-placeholder="' + (t.placeholder || "") + '"\n                      class="tagify__input"\n                      role="textbox"\n                      aria-multiline="false"></span>\n            </tags>'
            }, tag: function (t, e) {
                return "<tag title='" + (e.title || t) + "'\n                         contenteditable='false'\n                         spellcheck='false'\n                         class='tagify__tag " + (e.class ? e.class : "") + "'\n                         " + this.getAttributes(e) + ">\n                <x title='' class='tagify__tag__removeBtn' role='button' aria-label='remove tag'></x>\n                <div>\n                    <span class='tagify__tag-text'>" + t + "</span>\n                </div>\n            </tag>"
            }, dropdownItem: function (t) {
                var e = (t.value || t).replace(/`|'/g, "&#39;");
                return "<div " + this.getAttributes(t) + "\n                         class='tagify__dropdown__item " + (t.class ? t.class : "") + '\'\n                         tabindex="0"\n                         role="menuitem"\n                         aria-labelledby="dropdown-label">' + e + "</div>"
            }
        }, customEventsList: ["click", "add", "remove", "invalid", "input", "edit"], applySettings: function (t, e) {
            var i = t.getAttribute("data-whitelist"), s = t.getAttribute("data-blacklist");
            if (this.DEFAULTS.templates = this.templates, this.DEFAULTS.dropdown.itemTemplate = this.templates.dropdownItem, this.settings = this.extend({}, this.DEFAULTS, e), this.settings.readonly = t.hasAttribute("readonly"), this.isIE && (this.settings.autoComplete = !1), s && (s = s.split(this.settings.delimiters)) instanceof Array && (this.settings.blacklist = s), i && (i = i.split(this.settings.delimiters)) instanceof Array && (this.settings.whitelist = i), t.pattern) try {
            ...
            this.DOM.scope.parentNode.removeChild(this.DOM.scope), this.dropdown.hide.call(this)
        }, loadOriginalValues: function () {
            var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : this.DOM.originalInput.value;
            if (t) {
                this.removeAllTags();
                try {
                    t = JSON.parse(t)
            ...
            this.off = function (t, e) {
                ...
                var i;
                if (t) if (s.settings.isJQueryPlugin) a(s.DOM.originalInput).triggerHandler(t, [e]); else {
                    try {
            ...
            customBinding: function () {
                ...
                onFocusBlur: function (t) {
                    ...
                    var e, i, s = this, n = t.target.textContent;
                    ...
                    switch (t.key) {
                        case"Backspace":
                            "" != n && 8203 != n.charCodeAt(0) || (e = (e = this.DOM.scope.querySelectorAll("tag:not(.tagify--hide):not([readonly])"))[e.length - 1], !0 === this.settings.backspace ? this.removeTag(e) : "edit" == this.settings.backspace && this.editTag(e));
                            break;
                        case"Esc":
                        case"Escape":
                    ...
                    "TAGS" == t.target.tagName ? this.DOM.input.focus() : "X" == t.target.tagName ? this.removeTag(t.target.parentNode) : i && (e = this.getNodeIndex(i), this.trigger("click", {tag: i, index: e, data: this.value[e]}))
                }, onEditTagInput: function (t) {
                    var e = t.closest("tag"), i = this.getNodeIndex(e), s = this.input.normalize(t), n = s.toLowerCase() == t.originalValue.toLowerCase() || this.validateTag(s);
                    e.classList.toggle("tagify--invalid", !0 !== n), e.isValid = n, this.trigger("input", {tag: e, index: i, data: this.extend({}, this.value[i], {newValue: s})})
                }, onEditTagBlur: function (t) {
                    var e, i = t.closest("tag"), s = this.getNodeIndex(i), n = this.input.normalize(t) || t.originalValue, a = i.isValid;
                    void 0 !== a && !0 !== a || (t.textContent = n, this.value[s].value = n, this.update(), (e = t.cloneNode(!0)).removeAttribute("contenteditable"), i.title = n, i.classList.remove("tagify--editable"), t.parentNode.replaceChild(e, t), this.trigger("edit", {tag: i, index: s, data: this.value[s]}))
            ...
            value: "", set: function () {
                ...
                var t, e, i = 0 < arguments.length && void 0 !== arguments[0] && arguments[0], s = arguments[1];
                ...
                var t = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : this.DOM.input).innerText;
                return "settings" in this && this.settings.delimiters && (t = t.replace(/(?:\r\n|\r|\n)/g, this.settings.delimiters.source.charAt(1))), t = t.replace(/\s/g, " ").replace(/^\s+/, "")
            }, autocomplete: {
                suggest: function (t) {
            ...
            var e = this.settings, i = e.whitelist, s = e.delimiters, n = e.mode, a = !!i && i[0] instanceof Object, o = t instanceof Array && t[0] instanceof Object && "value" in t[0], r = [];
            if (o) return t;
            if ("number" == typeof t && (t = t.toString()), "string" == typeof t) {
                if (!t.trim()) return [];
                t = t.split(s).filter(function (t) {
                    return t
                }).map(function (t) {
                    return {value: t.trim()}
                })
            ...
            return s.split(this.settings.mixTagsAllowedAfter).filter(function (t) {
                ...
                n.isTagWhitelisted(i) && !n.settings.duplicates && -1 == n.isTagDuplicate(i) && (e = n.normalizeTags.call(n, i)[0], s = n.replaceMixStringWithTag(s, t, e).s)
            }), this.DOM.input.innerHTML = s, this.update(), s
        }, replaceMixStringWithTag: function (t, e, i, s) {
            return i && t && -1 != t.indexOf(e) && (s = this.createTagElem(i), this.value.push(i), t = t.replace(e, s.outerHTML + "&#8288;")), {s: t, tagElm: s}
        }, addMixTag: function (t) {
            if (t && this.state.tag) {
                for (var e, i, s, n, a = this.state.tag.prefix + this.state.tag.value, o = document.createNodeIterator(this.DOM.input, NodeFilter.SHOW_TEXT), r = 100; (e = o.nextNode()) && r--;) if (e.nodeType === Node.TEXT_NODE) {
                ...
                i && (this.value.push(t), this.update(), this.trigger("add", this.extend({}, {index: this.value.length, tag: i}, t))), this.state.tag = null
            }
        }, addTags: function (t, e) {
            var n = this, a = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : this.settings.skipInvalid, o = [];
            ...
            return this.DOM.input.removeAttribute("style"), t.forEach(function (t) {
                var e, i, s = {};
                if (t = Object.assign({}, t), "function" == typeof n.settings.transformTag && n.settings.transformTag.call(n, t), !0 !== (e = n.maxTagsReached() || n.validateTag.call(n, t.value))) {
                    if (a) return;
                    s["aria-invalid"] = !0, s.class = (t.class || "") + " tagify--notAllowed", s.title = e, n.markTagByValue(t.value), n.trigger("invalid", {data: t, index: n.value.length, message: e})
                }
                s.role = "tag", t.readonly && (s["aria-readonly"] = !0), i = n.createTagElem(n.extend({}, t, s)), o.push(i), function (t) {
                    var e = this.DOM.scope.lastElementChild;
                    e === this.DOM.input ? this.DOM.scope.insertBefore(t, e) : this.DOM.scope.appendChild(t)
                }.call(n, i), !0 === e ? (n.value.push(t), n.update(), n.DOM.scope.classList.toggle("hasMaxTags", n.value.length >= n.settings.maxTags), n.trigger("add", {tag: i, index: n.value.length - 1, data: t})) : n.settings.keepInvalidTags || setTimeout(function () {
                    n.removeTag(i, !0)
                }, 1e3)
            ...
            if (t && ("string" == typeof t && (t = this.getTagElmByValue(t)), t instanceof HTMLElement)) {
                var s, n = this.getNodeIndex(t);
                i && 10 < i ? (t.style.width = parseFloat(window.getComputedStyle(t).width) + "px", document.body.clientTop, t.classList.add("tagify--hide"), setTimeout(a, 400)) : a(), e || (s = this.value.splice(n, 1)[0], this.update(), this.trigger("remove", {tag: t, index: n, data: s}))
            }
            ...
            for (i = s.length; i--;) "class" != (e = s[i]) && t.hasOwnProperty(e) && (n += " " + e + (t[e] ? '="' + t[e] + '"' : ""));
            return n
        }, update: function () {
            ...
            init: function () {
                ...
                var t = '<div class="' + ("tagify__dropdown " + this.settings.dropdown.classname).trim() + '" role="menu"></div>';
                ...
                if (this.settings.whitelist.length) {
                    ...
                    e = this.dropdown.createListHTML.call(this, this.suggestedListItems), this.DOM.dropdown.innerHTML = this.minify(e), this.dropdown.highlightOption.call(this, this.DOM.dropdown.querySelector(".tagify__dropdown__item")), this.dropdown.position.call(this), this.DOM.scope.setAttribute("aria-expanded", !0), !this.DOM.dropdown.parentNode != document.body && (document.body.appendChild(this.DOM.dropdown), this.events.binding.call(this, !1), this.dropdown.events.binding.call(this))
                }
            }, hide: function () {
                this.DOM.dropdown && this.DOM.dropdown.parentNode == document.body && (document.body.removeChild(this.DOM.dropdown), this.DOM.scope.setAttribute("aria-expanded", !1), window.removeEventListener("resize", this.dropdown.position), this.dropdown.events.binding.call(this, !1), this.events.binding.call(this))
            }, position: function () {
                ...
                binding: function () {
                    var t = !(0 < arguments.length && void 0 !== arguments[0]) || arguments[0], e = this.listeners.dropdown = this.listeners.dropdown || {position: this.dropdown.position.bind(this), onKeyDown: this.dropdown.events.callbacks.onKeyDown.bind(this), onMouseOver: this.dropdown.events.callbacks.onMouseOver.bind(this), onClick: this.dropdown.events.callbacks.onClick.bind(this)}, i = t ? "addEventListener" : "removeEventListener";
                    ...
                    onKeyDown: function (t) {
                        var e = this.DOM.dropdown.querySelector("[class$='--active']") || this.DOM.dropdown.children[0], i = "";
                        switch (t.key) {
                            case"ArrowDown":
                            case"ArrowUp":
                            case"Down":
                        ...
                        if (0 == t.button && t.target != this.DOM.dropdown) {
                            ...
                            })[0]) ? (e = this.suggestedListItems[this.getNodeIndex(i)] || this.input.value, this.addTags([e], !0), this.dropdown.hide.call(this), setTimeout(function () {
                ...
                if (t) {
                    ...
                    }), t.classList.add(s), t.setAttribute("aria-selected", !0), e && (t.parentNode.scrollTop = t.clientHeight + t.offsetTop - t.parentNode.clientHeight), this.settings.autoComplete && !this.settings.dropdown.fuzzySearch && (i = this.suggestedListItems[this.getNodeIndex(t)].value || this.input.value, this.input.autocomplete.suggest.call(this, i))
                }
            }, filterListItems: function (t) {
                var e, i, s, n, a = this, o = [], r = this.settings.whitelist, l = this.settings.dropdown.maxItems || 1 / 0, d = 0;
                if (!t) return r.filter(function (t) {
                    return -1 == a.isTagDuplicate(t.value || t)
                }).slice(0, l);
                for (; d < r.length && (s = (((e = r[d] instanceof Object ? r[d] : {value: r[d]}).searchBy || "") + " " + e.value).toLowerCase().indexOf(t.toLowerCase()), i = this.settings.dropdown.fuzzySearch ? 0 <= s : 0 == s, n = !this.settings.duplicates && -1 < this.isTagDuplicate(e.value), i && !n && l-- && o.push(e), 0 != l); d++) ;
                return o
